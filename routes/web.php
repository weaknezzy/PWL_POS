...
Route::group(['prefix' => 'penjualan'], function () {
   Route::get('/', [JualController::class, 'index']);
   Route::post('/list', [JualController::class, 'list']);
   Route::get('/create', [JualController::class, 'create']); 
   Route::post('/', [JualController::class, 'store']);
   Route::get('/{id}', [JualController::class, 'show']);
   Route::get('/{id}/edit', [JualController::class, 'edit']);
   Route::put('/{id}', [JualController::class, 'update']);
   Route::delete('/{id}', [JualController::class, 'destroy']);
});
