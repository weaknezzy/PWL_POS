...
class AuthController extends Controller
{
    ...
    public function proses_login(Request $request)
    {
            ...
            if (Auth::attempt($credential)) 
            {
                ...
                //kalau berhasil simpan data user ya di vaariable $user
                $user = Auth::user();
            ...
            //pastikan kirim pesaan erorr juga kalo login gagal ya
    ...
    public function proses_register(Request $request)
    {
        ...
        //kalau gagal kembali ke halaman register dengan memunculkan pesan erorr
        if ($validator->fails()) {
