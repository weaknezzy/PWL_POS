...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                <label for="barang_kode" class="col-1 control-label col-form-label">Barang Kode</label>
                <div class="col-11">
                    <input type="text" class="form-control" id="barang_kode" name="barang_kode" value="{{ old('barang_kode') }}" required>
                    @error('barang_kode')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                    @if ($errors->has('barang_kode'))
                        <small class="form-text text-danger">{{ __('The Barang Kode field must be unique.') }}</small>
                    @endif
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="integer" class="form-control" id="harga_beli" name="harga_beli" required>
                    @error('harga_beli')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <input type="integer" class="form-control" id="harga_jual" name="harga_jual" required>
                    @error('harga_beli')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
